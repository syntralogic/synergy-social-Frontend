      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:36 }}>
            ...
            <div>
              <div style={{ fontFamily:'var(--font-syne), sans-serif', fontWeight:800, fontSize:20, color:'var(--text)', letterSpacing:'-0.3px' }}>
                Synergy Social
              </div>
          ...
          <h1 style={{ fontFamily:'var(--font-syne), sans-serif', fontSize:30, fontWeight:800, marginBottom:6, color:'var(--text)', letterSpacing:'-0.5px' }}>
          ...
          <form onSubmit={handleSubmit} noValidate>
                ...
                <div style={{ position:'relative' }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      outline:'none', transition:'border-color 0.2s', fontFamily:'var(--font-dm-sans), sans-serif',
                    }}
            ...
            <motion.button
              ...
              style={{
                ...
                fontFamily:'var(--font-syne), sans-serif', marginTop:4,
      ...
      <div style={{ position:'relative' }}>
        ...
        {React.cloneElement(children as React.ReactElement<React.InputHTMLAttributes<HTMLInputElement>>, {
          style: {
            ...
            fontSize:14, outline:'none', transition:'border-color 0.2s', fontFamily:'var(--font-dm-sans), sans-serif',
          },
